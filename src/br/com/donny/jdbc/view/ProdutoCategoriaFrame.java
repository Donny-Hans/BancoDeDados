package br.com.donny.jdbc.view;
...
import br.com.donny.jdbc.controller.CategoriaController;
import br.com.donny.jdbc.controller.ProdutoController;
import br.com.donny.jdbc.modelo.Categoria;
import br.com.donny.jdbc.modelo.Produto;
...
public class ProdutoCategoriaFrame extends JFrame {
	...
	public ProdutoCategoriaFrame() {
		...
		modelo.addColumn("Descriçao do Produto");
	...
	private void salvar() {
		if (!textoNome.getText().equals("") && !textoDescricao.getText().equals("")) {
			...
			JOptionPane.showMessageDialog(this, "Nome e Descroçao devem ser informados.");
		}
	}
